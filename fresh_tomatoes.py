...
data-trailer-youtube-id="{trailer_youtube_id}" data-movie-title="{movie_title}"
data-release-date="{release_date}" data-cast="{cast}" 
data-rating="{movie_rating}" data-toggle="modal" data-target="#trailer">
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        # Also makes movie parameters for release date, cast, and movie rating 
        # available to the trailer modal.
