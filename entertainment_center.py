...
# Below are the instances for the movie objects. 
# The cast for each movie is declared above movie instantiation so they can be 
# included in the movie constructor
dark_knight_cast = ["Christian Bale", "Heath Ledger", "Aaron Eckhart", 
...
age_of_ultron_cast = ["Robert Downey Jr.", "Chris Hemsworth", "Mark Ruffalo", 
...
beautiful_mind_cast = ["Russell Crowe", "Ed Harris", "Jennifer Connelly", 
...
guardians_cast = ["Chris Pratt", "Zoe Saldana", "Dave Bautista", "Vin Diesel", 
                  "Bradley Cooper", "Lee Pace"]
...
tron_legacy_cast = ["Jeff Bridges", "Garrett Hedlund", "Olivia Wilde", 
                    "Bruce Boxleitner"]
...
scott_pilgrim_cast = ["Michael Cera", "Mary Elizabeth Winstead", "Kieran Culkin", 
...
movies = [dark_knight, age_of_ultron, beautiful_mind, 
          guardians, tron_legacy, scott_pilgrim]
